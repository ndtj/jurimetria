...
## Por que este artigo é fundamental? {.scrollable}
...
## O Problema metodológico central {.scrollable}
...
## A Suposição implícita na literatura {.scrollable}
...
## Crítica a abordagens anteriores {.scrollable}
...
## Inferências problemáticas {.scrollable}
...
## A Ideia revolucionária {.scrollable}
...
## Determinantes da decisão de litigar {.scrollable}
...
## Suposição fundamental {.scrollable}
...
## O Modelo do “limite decisório” {.scrollable}
...
## Implicação metodológica profunda {.scrollable}
...
## Quando o resultado não é 50%? {.scrollable}
...
## Assimetria de riscos(stakes) {.scrollable}
...
## Objetivo da Seção II {.scrollable}
...
## O Que São “Preliminary Assumptions”? {.scrollable}
...
## Implicação Empírica {.scrollable}
...
## Por que isso importa? {.scrollable}
...
## Estrutura Geral Criada {.scrollable}
...
## Pergunta para Reflexão {.scrollable}
...
## Pressuposto 1: definição de disputa {.scrollable}
...
## Pressuposto 2: formas de encerramento {.scrollable}
...
## Implicação empírica imediata {.scrollable}
...
## Pressuposto 3: estrutura binária do resultado {.scrollable}
...
## Pressuposto 4: distribuição exógena das disputas {.scrollable}
...
## Pressuposto 5: modelo de período único {.scrollable}
...
## Pressuposto 6: existência de um padrão decisório {.scrollable}
...
## Pressuposto 7: consistência na aplicação {.scrollable}
...
## Pressuposto 8: independência do valor da causa {.scrollable}
...
## Pressuposto 9: incerteza imperfeita {.scrollable}
...
## Características do erro {.scrollable}
...
## Pressuposto 10: conhecimento da distribuição {.scrollable}
...
## Pressuposto 11: simetria inicial de stakes {.scrollable}
...
## Estrutura criada pelos pressupostos {.scrollable}
