...
# Parte 1 {background-color="#1a1a2e" .scrollable}

## O que é um desenho de pesquisa? {.scrollable}

---

## Pesquisa jurídica: o que fazemos de fato? {.scrollable}
...
## Definindo desenho de pesquisa {.scrollable}
...
## Por que isso importa para graduandos de Direito? {.scrollable}
...
## Duas dimensões do desenho {.scrollable}
...
## Do problema à conclusão {.scrollable}
...
## Uma boa pergunta de pesquisa {.scrollable}
...
## Afirmações empíricas vs. normativas {.scrollable}
...
# Parte 2 {background-color="#1a1a2e" .scrollable}

## Teoria, hipótese e teste empírico {.scrollable}

---

## O que é uma teoria? {.scrollable}
...
## Do fenômeno à teoria causal {.scrollable}
...
## Da teoria à hipótese {.scrollable}
...
## O papel da hipótese nula {.scrollable}
...
## Pensando com variáveis {.scrollable}
...
## Cuidado: correlação ≠ causalidade {.scrollable}
...
## Regras do caminho científico {.scrollable}
...
# Parte 3 {background-color="#1a1a2e" .scrollable}

## Aplicações no Direito: pesquisa jurídica empírica {.scrollable}

---

## O que é pesquisa jurídica empírica? {.scrollable}
...
## Exemplos de perguntas empíricas no Direito {.scrollable}
...
## Jurimetria: estatística aplicada ao Direito {.scrollable}
...
## Aplicando o desenho: estudo sobre prisão preventiva {.scrollable}
...
## Aplicando o desenho: impacto da Lei Maria da Penha {.scrollable}
...
## Aplicando o desenho: comportamento judicial no STF {.scrollable}
...
## Limitações da pesquisa empírica no Direito {.scrollable}
...
## Síntese: o que leva a uma boa pesquisa jurídica empírica {.scrollable}
